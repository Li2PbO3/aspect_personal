...
#ifndef _aspect_boundary_Neumann_condition_ascii_data_h
#define _aspect_boundary_Neumann_condition_ascii_data_h

#include <aspect/boundary_Neumann_condition/interface.h>
#include <aspect/simulator_access.h>
#include <aspect/utilities.h>

#pragma message("Compiling boundary_Neumann_condition/ascii_data.h")
...
namespace aspect
{
    namespace BoundaryNeumannCondition
    {
        ...
        /** 
         * A class that implements prescribed Neumann boundary conditions determined
