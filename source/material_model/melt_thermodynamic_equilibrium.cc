                      ...
                      if (fill_debug_fields)
                        {
                          ...
                          debug_field_indices.push_back(this->introspection().compositional_index_for_name("debug_c_l_an_eq"));
                          debug_field_indices.push_back(this->introspection().compositional_index_for_name("debug_grad_c_l_an_eq"));
                          // prescribed_field_out->prescribed_field_outputs[i][porosity_idx] = eq_melt_fraction; // placeholder
                          prescribed_field_out->prescribed_field_outputs[i][debug_field_indices[0]] = temporary_c_l_an_eq;
                          prescribed_field_out->prescribed_field_outputs[i][debug_field_indices[1]] = temporary_grad_c_l_an_eq[1]; 
                        }
